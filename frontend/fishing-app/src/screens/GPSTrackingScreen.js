  ...
  const confirmSOS = () => {
    Alert.alert(
      ...
      "This will immediately alert Marine Police and share your live location.\n\n" +
        "⚠️ Use only for real emergencies. False or prank reports may delay help " +
        "for others and can lead to penalties under maritime safety regulations.\n\n" +
        "Do you want to send the SOS now?",
      [
    ...
    <View className="flex-1 bg-seaGreen">
      ...
      <View className="bg-lightPeach p-4">
        <Text className="text-darkBlue font-semibold">
          Your Position: {location.coords.latitude.toFixed(6)},{" "}
